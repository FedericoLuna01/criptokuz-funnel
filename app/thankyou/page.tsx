...
import PixelTrackerLead from "@/components/pixel-tracker-lead";
...
const ThankYouPage = () => {
	return (
		<>
			<PixelTrackerLead />
			<main>
				<BackgroundLayout className="flex items-center justify-center pt-10">
					<Badge text="Pasos anteriores a la llamada" />
					<Hero
						isMain={false}
