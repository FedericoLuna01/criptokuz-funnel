...
const WhoAmI = () => {
  return (
    <section className="z-50 bg-background p-4">
      <div
        className="container mx-auto my-12 p-8 grid grid-cols-1 lg:grid-cols-2 max-w-7xl gap-x-0 lg:gap-x-4 gap-y-8 bg-[linear-gradient(219deg,#5ce1e666_10%,#fff_60%)] dark:bg-[linear-gradient(219deg,#233e47_10%,#0c0b0b_60%)] bg-transparent rounded-xl border border-border hover:shadow-[0px_0px_70px_-12px_rgba(18,193,243,.5)] transition-shadow duration-300"
      >
        <div className="flex flex-col gap-4 items-center lg:items-start ">
          ...
          <div className="flex flex-col gap-4 text-muted-foreground text-base lg:text-lg text-center lg:text-start ">
            <p>
