    ...
    <section>
      <BackgroundLayout>
        <div className="container flex flex-col items-center justify-center space-y-6 py-6 md:py-10 z-50">
          ...
          <p className="max-w-3xl text-center text-base md:text-xl text-muted-foreground z-50">
            Sin señales, sin indicadores, ni robots mágicos, con un solo sistema validado, con scorecard y métricas tangibles
          </p>
          <div
            className="mx-auto max-w-5xl w-full h-full p-3 border border-input rounded-lg hover:shadow-[0px_0px_70px_-12px_rgba(18,193,243,.5)] transition-shadow duration-300 z-50"
          >
            <iframe
